...
@app.route('/acercaDe')
def informacion():
    return render_template('about.html', usuarioCorrecto=usuarioCorrecto, correoUsuario=correoUsuario, isAdmin=isAdmin)
...
def prediccion():
    ...
    global correoUsuario
    if usuarioCorrecto:
        return render_template('prediccion.html', usuarioCorrecto=usuarioCorrecto, correoUsuario=correoUsuario, isAdmin=isAdmin)
    else:
        return redirect(url_for('login'))
...
@app.route('/contacto')
def contacto():
    return render_template('contactDocente.html', usuarioCorrecto=usuarioCorrecto, correoUsuario=correoUsuario, isAdmin=isAdmin)
